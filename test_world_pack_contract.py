...
def valid_manifest() -> dict[str, object]:
    return {
        ...
        "configuration": {
            ...
            "terrainInput": "procedural-route-v1",
        },
...
def test_acquisition_metadata_never_retains_workstation_path(tmp_path: Path):
    ...
    source = AcquiredSource(
        ...
        source_version="owner-recording-v1",
        acquired_at="2026-08-26T00:00:00Z",
        source_date=None,
        licence_id="owner-controlled-private-source",
        licence_uri="owner-policy:private-source",
        licence_evidence_sha256="1" * 64,
        attribution="Owner recording",
        retention_allowed=True,
        derivatives_allowed=True,
        redistribution="private_only",
        public_use_obligations=("do-not-redistribute",),
        third_party_rights="none-declared",
        decision="private_pack_only",
        decision_reason="Owner recording stays in the private pack.",
        adapter="local-file",
        adapter_version="1",
    )
