...
export function RegionInspector({
  ...
  return (
    <aside className="absolute inset-x-3 bottom-20 z-30 flex max-h-[44dvh] flex-col overflow-hidden rounded-md border border-border bg-background/94 shadow-2xl backdrop-blur sm:inset-x-auto sm:right-5 sm:w-[360px] xl:bottom-auto xl:right-4 xl:top-48 xl:max-h-[calc(100dvh-16rem)]">
