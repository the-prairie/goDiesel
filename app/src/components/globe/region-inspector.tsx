...
export function RegionInspector({
  ...
  return (
    <aside className="absolute inset-x-3 bottom-20 z-30 flex max-h-[44dvh] flex-col overflow-hidden rounded-md border border-border bg-background/94 shadow-2xl backdrop-blur sm:inset-x-auto sm:bottom-auto sm:right-4 sm:top-48 sm:w-[360px] sm:max-h-[calc(100dvh-16rem)]">
