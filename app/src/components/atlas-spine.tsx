        ...
        <div className="flex items-center gap-3 border-b border-line px-3 py-4 lg:px-4">
          ...
          >
            ...
            <span className="hidden min-w-0 flex-1 lg:grid">
              ...
              <span className="truncate text-caption text-ink-muted">Weathered atlas</span>
            </span>
          </Link>
        </div>

        <nav aria-label="Primary" className="relative flex min-h-0 flex-1 flex-col py-3">
          <div
            aria-hidden="true"
