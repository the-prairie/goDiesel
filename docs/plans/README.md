...
| --- | --- | --- |
| [Agent Operating System](2026-08-31-agent-operating-system-plan.md) | In progress | Add Phase 3 proof fingerprints and impact-directed verification while keeping ADR-0016 proposed until two real adapters prove leverage |
